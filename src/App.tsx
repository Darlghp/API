        ...
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-neutral-400 text-sm">A simple REST API for country flags ready to be implemented</p>
            </div>
          </div>
          <div className="flex items-center gap-6 text-sm text-neutral-400">
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4 text-emerald-500" />
              <span>API Status: <strong className="text-emerald-500 font-medium">Online</strong></span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        ...
        <section className="space-y-6">
          <div className="flex justify-between items-end">
            ...
            <div className="text-sm text-emerald-400 flex items-center gap-1 bg-emerald-400/10 px-3 py-1.5 rounded-full font-medium">
              ✔ CORS Enabled
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 flex flex-col h-full">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-medium text-white">Live API Response</h3>
                <div className="flex gap-2">
                  <button 
                    onClick={() => testApi('/api/flags?search=brazil')}
                    className="text-xs bg-neutral-800 hover:bg-neutral-700 text-neutral-300 px-3 py-1.5 rounded-lg transition-colors"
                  >
                    /api/flags?search=brazil
                  </button>
                  <button 
        ...
        <section className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-neutral-500 text-sm">Browse the data returned from the API.</p>
            </div>
            <div className="flex items-center gap-3">
